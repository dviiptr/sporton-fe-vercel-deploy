...
const TransactionsModal = ({isOpen, onClose, transaction, onStatusChange}: TransactionModalProps) => {
                 ...
                 />) : (
                    ...
                    <div className="w-full">
                      ...
                      <div className="bg-gray-100 rounded-md flex flex-col gap-2.5 p-4 text-sm mb-5"> 
                        ...
                        <div className="flex justify-between font-medium">
                            <div className="opacity-50">Contac</div>
                        ...
                        <div className="flex justify-between  gap-10 font-medium">
                         ...
                         <div className="border border-gray-200 rounded-lg p-2 flex items-center gap-2">
                            ...
                            <div className="font-medium text-sm">{item.productId.name}
                            </div>
                         ...
                         <div className="flex justify-between text-sm mt-6">
                            ...
                            <div className="text-primary font-semibold">{PriceFormatter(parseInt(transaction.totalPayment))}
                         </div>
                    </div>
                    <div className="flex justify-end gap-5 mt-12">
                        {
                            isUpdating ? (
                                <div className="text-center">Updateing...</div>
                            ): (
                        <>
                        <Button 
