                ...
                banks.map((data) => (
                    <div className=" bg-white rounded-lg border border-gray-200" key={data._id}>
                        ...
                        <div className="flex gap-2 -mt-5 text-gray-600">
                            <Button className="cursor-pointer" onClick={() => onEdit(data) } size="icon" variant="ghost"  >
                                    <FiEdit2  size={20}/>
                                </Button>
                                 <Button className="cursor-pointer" onClick= {() => onDelete(data._id)} size="icon" variant="ghost" >
                                    <FiTrash2 size={20}/>
                                </Button>
                        </div>
                    </div>
